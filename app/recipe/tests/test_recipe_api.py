...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(
            email='otheruser@example.com', password='test123')
    ...
    def test_create_recipe(self):
        ...
        # Get the recipe from the database with the same ID
        # as the one in the response data.
        recipe = Recipe.objects.get(id=res.data['id'])
        # Check that the recipe was created with the same
        # values as the payload.
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='nJk2v@example.com', password='test123')
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        """
        Create a new recipe. The format='json' is required
        to send the payload in JSON format because the payload
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.tags.count(), 2)
        # Ensure that the tags was not created twice.
